...
static double wsums[N_MAX/2+1];
static Complex gain[N_MAX/2+1];
static Complex gainD[N_MAX/2+1];
static Complex zero[N_MAX/2+1][4];
static Complex zeroD[N_MAX/2+1][4];
